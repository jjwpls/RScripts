...
# The goal here is to use the 2004 general election data as the universe, and
#  
# (1) perform random simple surveys and plot the distribution the sample means of 
# the three candidates' votes (Bush, Kerry and Nader), 
...
# Then, we definea a function "samplemean()" to calcuate the sample means of the three candidates. 
